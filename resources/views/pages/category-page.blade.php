            ...
            <div class="card card-custom card-stretch">
                ...
                <div class="card-body px-5">
                    ...
                    <div
                        ...
                        {{--web--}}
                        <div class="navi-section mb-2 font-size-h1 font-weight-bold pb-0 text-uppercase">Kategoriler
                        </div>
                        <hr>
                        ...
                        <!--begin:Item-->
                            <div class="navi-item my-2">
                                <a href="{{$item->slug}}"
                                   class="navi-link @if(Request::segment(2) == $item->slug) active @endif">
                                    ...
                                    @if($loop->iteration <= 3)
                                        <span
                                            class="label label-sm label-light-info label-inline text-info pulse pulse-info p-3">Popüler<span
                                                class="pulse-ring"></span></span>
                                    @endif

                                    @if($loop->iteration == 8)
                                        <span
                                            class="label label-sm label-light-success label-inline text-success pulse pulse-success p-3">Yeni<span
                                                class="pulse-ring"></span></span>
                                    @endif
                                </a>
                            </div>
                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-body d-flex align-items-center justify-content-between flex-wrap py-3">
                        ...
                        <div class="d-flex align-items-center mr-2 py-2">
                            <h3 class="font-weight-bold mb-0 mr-1">{{ $page_title }} <span
                                    class="text-muted font-size-h6">({{ $category_result->count() }})</span></h3>
                        </div>
                        <!--end::Info-->
                        <!--begin::Users-->
