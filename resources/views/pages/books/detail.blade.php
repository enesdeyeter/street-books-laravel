                ...
                <div class="card-body">
                    <div id="show-photo">
                        <div class="mb-7 text-center">
                            <img class="img-responsive" alt="image-{{ $base_book->slug }}" src="{{ asset($base_book->book_image) }}" style="border-radius: 4px; max-width: 280px !important; max-height: 600px !important;">
                        </div>
                    </div>
                    <div class="d-flex">
                        <!--begin: Pic-->
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap mb-3">
                                <div class="mr-3">
                                    ...
                                    <div class="d-flex flex-wrap my-2">
                                        <span class="text-muted text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2 text-capitalize" data-toggle="popover" data-placement="top" data-content="Kitap Yazarı">
                                        ...
                                        <span class="text-muted text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2 text-capitalize" data-toggle="popover" data-placement="top" data-content="Yayınevi">
                                          <span class="svg-icon svg-icon-md svg-icon-gray-500 mr-1">
                                        ...
                                        <span href="#" class="text-muted text-hover-primary font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2 text-capitalize" data-toggle="popover" data-placement="top" data-content="Kitap Kategorisi">
                                          <span class="svg-icon svg-icon-md svg-icon-gray-500 mr-1">
                                        ...
                                        <span href="#" class="text-muted text-hover-primary font-weight-bold" data-toggle="popover" data-placement="top" data-content="ISBN Numarası">
                                          <span class="svg-icon svg-icon-md svg-icon-gray-500 mr-1">
                                             <!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Map/Marker2.svg-->
                                             <svg xmlns="http://www.w3.org/2000/svg"
                                                  xmlns:xlink="http://www.w3.org/1999/xlink"
                                ...
                                <div class="my-lg-0 my-1" data-toggle="popover" data-placement="top" data-content="Kitabı ekleyen kişi">
                                    <span class="btn btn-sm btn-light-primary font-weight-bolder text-uppercase mr-3"><i class="fa fa-info-circle"></i> {{ $check->getUserName->name }}</span>
                                </div>
                            </div>
                            <!--end: Title-->
